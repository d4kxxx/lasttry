...
async def main(page: ft.Page):
    ...
    #Tiktok
    url_tiktok = ft.TextField(label="Type The TikTok Video URL Here", width=800, border_color="green",)
    btn1_tiktok = ft.FloatingActionButton(icon=ft.icons.VIDEO_LIBRARY, text="Download Video", bgcolor="green", on_click=tik_download_video)
    btn2_tiktok = ft.FloatingActionButton(icon=ft.icons.AUDIOTRACK, text="Download Audio", bgcolor="green", on_click=tik_audio_download)
    ...
    t = ft.Tabs(
        ...
        tabs=[
            ...
            ft.Tab(
                tab_content=ft.Icon(ft.icons.TIKTOK, color="green"),
